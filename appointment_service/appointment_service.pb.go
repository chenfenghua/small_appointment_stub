...
const (
	ReserveStatus_UNKNOWN  ReserveStatus = 0 // 未知
	ReserveStatus_SUCCESS  ReserveStatus = 1 // 成功
	ReserveStatus_FAILED   ReserveStatus = 2 // 失败
	ReserveStatus_PADDING  ReserveStatus = 3 // 队列中
	ReserveStatus_HANDLING ReserveStatus = 4 // 处理中
)
...
func (ReserveStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_appointment_service_appointment_service_proto_enumTypes[0].Descriptor()
}

func (ReserveStatus) Type() protoreflect.EnumType {
	return &file_appointment_service_appointment_service_proto_enumTypes[0]
}
...
type AppointmentProject struct {
	...
	ProjectId   string                          `protobuf:"bytes,8,opt,name=project_id,json=projectId,proto3" json:"project_id,omitempty"`                                                                // 客户端生成的uuid，保证活动内唯一即可
}
...
func (x *AppointmentProject) GetProjectId() string {
	if x != nil {
		return x.ProjectId
	}
	return ""
...
type ExtraInfo struct {
	...
	FieldValue string `protobuf:"bytes,2,opt,name=field_value,json=fieldValue,proto3" json:"field_value,omitempty"` // 字段值，预约时使用
	IsMust     bool   `protobuf:"varint,3,opt,name=is_must,json=isMust,proto3" json:"is_must,omitempty"`            // 是否必填
	FieldType  string `protobuf:"bytes,4,opt,name=field_type,json=fieldType,proto3" json:"field_type,omitempty"`    // 字段类型
}
...
func (x *ExtraInfo) GetFieldType() string {
	if x != nil {
		return x.FieldType
	}
	return ""
...
type ReserveInfo struct {
	...
	Number    int32  `protobuf:"varint,4,opt,name=number,proto3" json:"number,omitempty"` //预约人数？
	Total     int32  `protobuf:"varint,5,opt,name=total,proto3" json:"total,omitempty"`   // 本列可预约的原始总量
}
...
func (x *ReserveInfo) GetDate() string {
	if x != nil {
		return x.Date
	}
	return ""
...
func (x *ReserveInfo) GetBeginTime() string {
	if x != nil {
		return x.BeginTime
	}
	return ""
...
func (x *ReserveInfo) GetEndTime() string {
	if x != nil {
		return x.EndTime
	}
	return ""
...
func (x *ReserveInfo) GetNumber() int32 {
	if x != nil {
		return x.Number
	}
	return 0
...
func (x *ReserveInfo) GetTotal() int32 {
	if x != nil {
		return x.Total
	}
	return 0
...
type GetPersonReserveListReq struct {
	...
	ProjectId  string `protobuf:"bytes,6,opt,name=project_id,json=projectId,proto3" json:"project_id,omitempty"`    // 默认为空，不进行过滤，且前置条件为activity_id不为空
}
...
func (x *GetPersonReserveListReq) GetProjectId() string {
	if x != nil {
		return x.ProjectId
	}
	return ""
...
type ReserveDetail struct {
	...
	ActivityId    string         `protobuf:"bytes,1,opt,name=activity_id,json=activityId,proto3" json:"activity_id,omitempty"`           // 唯一id，
	Info          []*ReserveInfo `protobuf:"bytes,2,rep,name=info,proto3" json:"info,omitempty"`                                         // 预约信息，可以一次预约多个
	ExtraInfo     []*ExtraInfo   `protobuf:"bytes,3,rep,name=extra_info,json=extraInfo,proto3" json:"extra_info,omitempty"`              // 每次预约单只有一个预约人
	Timestamp     int64          `protobuf:"varint,4,opt,name=timestamp,proto3" json:"timestamp,omitempty"`                              // 发起预约的时间戳(后台返回）仅查询时会需要
	Status        int32          `protobuf:"varint,5,opt,name=status,proto3" json:"status,omitempty"`                                    // 预约状态（0-未知、1-预约成功、2-预约失败、3-预约进入排队）
	ProjectId     string         `protobuf:"bytes,6,opt,name=project_id,json=projectId,proto3" json:"project_id,omitempty"`              // 预约项目的ID
	ReserveNumber int64          `protobuf:"varint,7,opt,name=reserve_number,json=reserveNumber,proto3" json:"reserve_number,omitempty"` // 预约单号
}
...
func (x *ReserveDetail) GetInfo() []*ReserveInfo {
	if x != nil {
		return x.Info
	}
	return nil
...
func (x *ReserveDetail) GetProjectId() string {
	if x != nil {
		return x.ProjectId
	}
	return ""
...
func (x *ReserveDetail) GetReserveNumber() int64 {
	if x != nil {
...
type ActivityExposureReportReq struct {
	...
	ProjectId  string `protobuf:"bytes,3,opt,name=project_id,json=projectId,proto3" json:"project_id,omitempty"`    // 来过活动对应的项目ID
}
...
func (x *ActivityExposureReportReq) GetProjectId() string {
	if x != nil {
		return x.ProjectId
	}
	return ""
...
type ActivityDetail struct {
	...
	ReserveTime      int32            `protobuf:"varint,2,opt,name=reserve_time,json=reserveTime,proto3" json:"reserve_time,omitempty"`                  // 预约次数（活动被预约的次数）
	WatchMemberCount int32            `protobuf:"varint,3,opt,name=watch_member_count,json=watchMemberCount,proto3" json:"watch_member_count,omitempty"` // 来过人数（这个正常需要上报接口）
...
func (x *ActivityDetail) GetReserveTime() int32 {
	if x != nil {
...
func (x *ActivityDetail) GetWatchMemberCount() int32 {
	if x != nil {
		return x.WatchMemberCount
	}
	return 0
}
...
type GetReserveNumberByActivityReq struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	ActivityId string `protobuf:"bytes,1,opt,name=activity_id,json=activityId,proto3" json:"activity_id,omitempty"`
	Date       string `protobuf:"bytes,2,opt,name=date,proto3" json:"date,omitempty"`                            // 日期utc时间戳
	ProjectId  string `protobuf:"bytes,3,opt,name=project_id,json=projectId,proto3" json:"project_id,omitempty"` // 项目ID
}

func (x *GetReserveNumberByActivityReq) Reset() {
	*x = GetReserveNumberByActivityReq{}
	if protoimpl.UnsafeEnabled {
		mi := &file_appointment_service_appointment_service_proto_msgTypes[23]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *GetReserveNumberByActivityReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetReserveNumberByActivityReq) ProtoMessage() {}

func (x *GetReserveNumberByActivityReq) ProtoReflect() protoreflect.Message {
	mi := &file_appointment_service_appointment_service_proto_msgTypes[23]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetReserveNumberByActivityReq.ProtoReflect.Descriptor instead.
func (*GetReserveNumberByActivityReq) Descriptor() ([]byte, []int) {
	return file_appointment_service_appointment_service_proto_rawDescGZIP(), []int{23}
}

func (x *GetReserveNumberByActivityReq) GetActivityId() string {
	if x != nil {
		return x.ActivityId
	}
	return ""
...
func (x *GetReserveNumberByActivityReq) GetDate() string {
	if x != nil {
		return x.Date
	}
	return ""
...
func (x *GetReserveNumberByActivityReq) GetProjectId() string {
	if x != nil {
		return x.ProjectId
	}
	return ""
...
type GetReserveNumberByActivityRsp struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Data map[string]int32 `protobuf:"bytes,1,rep,name=data,proto3" json:"data,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"` // 以开始_结束时间作为key,value为预约的人数。
}

func (x *GetReserveNumberByActivityRsp) Reset() {
	*x = GetReserveNumberByActivityRsp{}
	if protoimpl.UnsafeEnabled {
		mi := &file_appointment_service_appointment_service_proto_msgTypes[24]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *GetReserveNumberByActivityRsp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetReserveNumberByActivityRsp) ProtoMessage() {}

func (x *GetReserveNumberByActivityRsp) ProtoReflect() protoreflect.Message {
	mi := &file_appointment_service_appointment_service_proto_msgTypes[24]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetReserveNumberByActivityRsp.ProtoReflect.Descriptor instead.
func (*GetReserveNumberByActivityRsp) Descriptor() ([]byte, []int) {
	return file_appointment_service_appointment_service_proto_rawDescGZIP(), []int{24}
}

func (x *GetReserveNumberByActivityRsp) GetData() map[string]int32 {
	if x != nil {
		return x.Data
	}
	return nil
...
var file_appointment_service_appointment_service_proto_rawDesc = []byte{
	...
	0x63, 0x74, 0x73, 0x22, 0xf8, 0x02, 0x0a, 0x12, 0x41, 0x70, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x6d,
	...
	0x52, 0x09, 0x65, 0x78, 0x74, 0x72, 0x61, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x1d, 0x0a, 0x0a, 0x70,
	0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x08, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x09, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x49, 0x64, 0x1a, 0x62, 0x0a, 0x0a, 0x49, 0x6e,
	...
	0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x28, 0x2e, 0x61, 0x70, 0x70, 0x6f,
	...
	,
	...
	0x0a, 0x6d, 0x61, 0x78, 0x5f, 0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x18, 0x03, 0x20, 0x01, 0x28,
	0x05, 0x52, 0x09, 0x6d, 0x61, 0x78, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x22, 0x83, 0x01, 0x0a,
	0x09, 0x45, 0x78, 0x74, 0x72, 0x61, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x1d, 0x0a, 0x0a, 0x66, 0x69,
	...
	,
	...
	,
	...
	0x49, 0x64, 0x22, 0xa1, 0x02, 0x0a, 0x0d, 0x52, 0x65, 0x73, 0x65, 0x72, 0x76, 0x65, 0x44, 0x65,
	0x74, 0x61, 0x69, 0x6c, 0x12, 0x1f, 0x0a, 0x0b, 0x61, 0x63, 0x74, 0x69, 0x76, 0x69, 0x74, 0x79,
	0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x61, 0x63, 0x74, 0x69, 0x76,
	0x69, 0x74, 0x79, 0x49, 0x64, 0x12, 0x34, 0x0a, 0x04, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x02, 0x20,
	...
	0x65, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x04, 0x69, 0x6e, 0x66, 0x6f, 0x12, 0x3d, 0x0a, 0x0a, 0x65,
	0x78, 0x74, 0x72, 0x61, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32,
	0x1e, 0x2e, 0x61, 0x70, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x6d, 0x65, 0x6e, 0x74, 0x5f, 0x73, 0x65,
	0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x45, 0x78, 0x74, 0x72, 0x61, 0x49, 0x6e, 0x66, 0x6f, 0x52,
	0x09, 0x65, 0x78, 0x74, 0x72, 0x61, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x1c, 0x0a, 0x09, 0x74, 0x69,
	...
	,
	...
	,
	...
	,
	...
	0x65, 0x3a, 0x02, 0x38, 0x01, 0x2a, 0x50, 0x0a, 0x0d, 0x52, 0x65, 0x73, 0x65, 0x72, 0x76, 0x65,
	...
	,
...
var file_appointment_service_appointment_service_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_appointment_service_appointment_service_proto_msgTypes = make([]protoimpl.MessageInfo, 27)
var file_appointment_service_appointment_service_proto_goTypes = []interface{}{
	(ReserveStatus)(0),                    // 0: appointment_service.ReserveStatus
	(*PublishActivityReq)(nil),            // 1: appointment_service.PublishActivityReq
	(*AppointmentInfo)(nil),               // 2: appointment_service.AppointmentInfo
	(*AppointmentProject)(nil),            // 3: appointment_service.AppointmentProject
	(*AppointmentIntroduction)(nil),       // 4: appointment_service.AppointmentIntroduction
	(*AppointmentTimeSlot)(nil),           // 5: appointment_service.AppointmentTimeSlot
	(*TimeSlot)(nil),                      // 6: appointment_service.TimeSlot
	(*ExtraInfo)(nil),                     // 7: appointment_service.ExtraInfo
	(*PublishActivityRsp)(nil),            // 8: appointment_service.PublishActivityRsp
	(*GetPersonActivityListReq)(nil),      // 9: appointment_service.GetPersonActivityListReq
	(*GetPersonActivityListRsp)(nil),      // 10: appointment_service.GetPersonActivityListRsp
	(*ReserveReq)(nil),                    // 11: appointment_service.ReserveReq
	(*ReserveInfo)(nil),                   // 12: appointment_service.ReserveInfo
	(*ReserveRsp)(nil),                    // 13: appointment_service.ReserveRsp
	(*GetPersonReserveListReq)(nil),       // 14: appointment_service.GetPersonReserveListReq
	(*ReserveDetail)(nil),                 // 15: appointment_service.ReserveDetail
	(*GetPersonReserveListRsp)(nil),       // 16: appointment_service.GetPersonReserveListRsp
	(*GetPersonReserveDetailReq)(nil),     // 17: appointment_service.GetPersonReserveDetailReq
	(*GetPersonReserveDetailRsp)(nil),     // 18: appointment_service.GetPersonReserveDetailRsp
	(*ActivityExposureReportReq)(nil),     // 19: appointment_service.ActivityExposureReportReq
	(*ActivityExposureReportRsp)(nil),     // 20: appointment_service.ActivityExposureReportRsp
	(*GetPersonActivityReq)(nil),          // 21: appointment_service.GetPersonActivityReq
	(*ActivityDetail)(nil),                // 22: appointment_service.ActivityDetail
	(*GetPersonActivityRsp)(nil),          // 23: appointment_service.GetPersonActivityRsp
	(*GetReserveNumberByActivityReq)(nil), // 24: appointment_service.GetReserveNumberByActivityReq
	(*GetReserveNumberByActivityRsp)(nil), // 25: appointment_service.GetReserveNumberByActivityRsp
	nil,                                   // 26: appointment_service.AppointmentProject.InfosEntry
	nil,                                   // 27: appointment_service.GetReserveNumberByActivityRsp.DataEntry
}
var file_appointment_service_appointment_service_proto_depIdxs = []int32{
	2,  // 0: appointment_service.PublishActivityReq.info:type_name -> appointment_service.AppointmentInfo
	7,  // 1: appointment_service.AppointmentInfo.extra_info:type_name -> appointment_service.ExtraInfo
	4,  // 2: appointment_service.AppointmentInfo.introductions:type_name -> appointment_service.AppointmentIntroduction
	3,  // 3: appointment_service.AppointmentInfo.projects:type_name -> appointment_service.AppointmentProject
	26, // 4: appointment_service.AppointmentProject.infos:type_name -> appointment_service.AppointmentProject.InfosEntry
	6,  // 5: appointment_service.AppointmentTimeSlot.times:type_name -> appointment_service.TimeSlot
	22, // 6: appointment_service.GetPersonActivityListRsp.infos:type_name -> appointment_service.ActivityDetail
	15, // 7: appointment_service.ReserveReq.detail:type_name -> appointment_service.ReserveDetail
	12, // 8: appointment_service.ReserveDetail.info:type_name -> appointment_service.ReserveInfo
	7,  // 9: appointment_service.ReserveDetail.extra_info:type_name -> appointment_service.ExtraInfo
	15, // 10: appointment_service.GetPersonReserveListRsp.data:type_name -> appointment_service.ReserveDetail
	15, // 11: appointment_service.GetPersonReserveDetailRsp.detail:type_name -> appointment_service.ReserveDetail
	2,  // 12: appointment_service.ActivityDetail.infos:type_name -> appointment_service.AppointmentInfo
	22, // 13: appointment_service.GetPersonActivityRsp.info:type_name -> appointment_service.ActivityDetail
	27, // 14: appointment_service.GetReserveNumberByActivityRsp.data:type_name -> appointment_service.GetReserveNumberByActivityRsp.DataEntry
	5,  // 15: appointment_service.AppointmentProject.InfosEntry.value:type_name -> appointment_service.AppointmentTimeSlot
	1,  // 16: appointment_service.AppointmentService.PublishActivity:input_type -> appointment_service.PublishActivityReq
	9,  // 17: appointment_service.AppointmentService.GetPersonActivityList:input_type -> appointment_service.GetPersonActivityListReq
	21, // 18: appointment_service.AppointmentService.GetPersonActivity:input_type -> appointment_service.GetPersonActivityReq
	11, // 19: appointment_service.AppointmentService.Reserve:input_type -> appointment_service.ReserveReq
	14, // 20: appointment_service.AppointmentService.GetPersonReserveList:input_type -> appointment_service.GetPersonReserveListReq
	17, // 21: appointment_service.AppointmentService.GetPersonReserveDetail:input_type -> appointment_service.GetPersonReserveDetailReq
	24, // 22: appointment_service.AppointmentService.GetReserveNumberByActivity:input_type -> appointment_service.GetReserveNumberByActivityReq
	19, // 23: appointment_service.AppointmentService.ActivityExposureReport:input_type -> appointment_service.ActivityExposureReportReq
	8,  // 24: appointment_service.AppointmentService.PublishActivity:output_type -> appointment_service.PublishActivityRsp
	10, // 25: appointment_service.AppointmentService.GetPersonActivityList:output_type -> appointment_service.GetPersonActivityListRsp
	23, // 26: appointment_service.AppointmentService.GetPersonActivity:output_type -> appointment_service.GetPersonActivityRsp
	13, // 27: appointment_service.AppointmentService.Reserve:output_type -> appointment_service.ReserveRsp
	16, // 28: appointment_service.AppointmentService.GetPersonReserveList:output_type -> appointment_service.GetPersonReserveListRsp
	18, // 29: appointment_service.AppointmentService.GetPersonReserveDetail:output_type -> appointment_service.GetPersonReserveDetailRsp
	25, // 30: appointment_service.AppointmentService.GetReserveNumberByActivity:output_type -> appointment_service.GetReserveNumberByActivityRsp
	20, // 31: appointment_service.AppointmentService.ActivityExposureReport:output_type -> appointment_service.ActivityExposureReportRsp
...
func file_appointment_service_appointment_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_appointment_service_appointment_service_proto_msgTypes[23].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetReserveNumberByActivityReq); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_appointment_service_appointment_service_proto_msgTypes[24].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetReserveNumberByActivityRsp); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_appointment_service_appointment_service_proto_enumTypes,
